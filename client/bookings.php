    ...
    <?php else: ?>
        <div class="card border-0 shadow-sm">
            <div class="card-body py-5 text-center">
                <img src="/beautyclick/assets/images/empty-bookings.svg" alt="No Bookings" style="max-width: 200px; margin-bottom: 1.5rem;">
...
<!-- Add empty-bookings.svg if it doesn't exist -->
<script>
document.addEventListener('DOMContentLoaded', function() {
    // Check if the image exists
    const emptyBookingsImg = document.querySelector('img[src="/beautyclick/assets/images/empty-bookings.svg"]');
    if (emptyBookingsImg) {
        emptyBookingsImg.addEventListener('error', function() {
            // Replace with a Font Awesome icon if image doesn't exist
            const container = this.parentElement;
            const iconDiv = document.createElement('div');
            iconDiv.innerHTML = '<i class="fas fa-calendar-alt fa-5x text-muted mb-4"></i>';
            container.replaceChild(iconDiv, this);
        });
    }
});
</script>
