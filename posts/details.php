<?php
// posts/details.php - Display post details and comments (alternative to view.php)
...
$sql = "SELECT p.*, u.full_name AS artist_name, u.avatar AS artist_avatar, 
        ap.bio AS artist_bio, ap.avg_rating, u.user_id AS artist_id
        FROM posts p 
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="shareDropdown">
                                    <li>
                                        <a class="dropdown-item" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo urlencode('http://' . $_SERVER['HTTP_HOST'] . '/beautyclick/posts/details.php?id=' . $post_id); ?>" target="_blank">
                                            <i class="fab fa-facebook text-primary me-2"></i> Facebook
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="https://twitter.com/intent/tweet?url=<?php echo urlencode('http://' . $_SERVER['HTTP_HOST'] . '/beautyclick/posts/details.php?id=' . $post_id); ?>&text=<?php echo urlencode($post['title']); ?>" target="_blank">
                                            <i class="fab fa-twitter text-info me-2"></i> Twitter
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item copy-link" href="#" data-url="<?php echo 'http://' . $_SERVER['HTTP_HOST'] . '/beautyclick/posts/details.php?id=' . $post_id; ?>">
                                            ...
                                            <?php if (is_logged_in() && ($_SESSION['user_id'] == $comment['user_id'] || user_has_role('admin'))): ?>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        <li>
                                                            <a class="dropdown-item text-danger" href="/beautyclick/posts/delete_comment.php?id=<?php echo $comment['comment_id']; ?>&post_id=<?php echo $post_id; ?>">
        ...
        <div class="col-lg-4">
            ...
            <div class="card mb-4 border-0 shadow-sm">
                <div class="card-body">
                    ...
                    <?php if (count($artist_services) > 0): ?>
                        <?php foreach ($artist_services as $service): ?>
            ...
            <div class="card mb-4 border-0 shadow-sm">
                <div class="card-body">
                    ...
                    <div class="related-post mb-3 pb-3 border-bottom">
                        ...
                        <a href="/beautyclick/posts/details.php?id=<?php echo $related['post_id']; ?>" class="d-block mb-2">
                            <img src="/beautyclick/assets/uploads/posts/<?php echo $related['image']; ?>" 
                                 class="img-fluid rounded" alt="<?php echo $related['title']; ?>">
                        </a>
                        <?php endif; ?>
                        <h6>
                            <a href="/beautyclick/posts/details.php?id=<?php echo $related['post_id']; ?>" 
